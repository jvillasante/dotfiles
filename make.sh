...
files=".doom.d .oh-my-zsh.d .bin .mbsyncrc .profile .bashrc .zshenv .zshrc .tmux.conf .tmux-macos.conf .tmux-linux.conf .clang-tidy .editorconfig .sbclrc .rustfmt.toml"
for file in $files; do
    unlink ~/$file
