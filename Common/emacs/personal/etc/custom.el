...
(custom-set-variables
 ...
 '(package-selected-packages
      '(adoc-mode anzu apheleia avy bind-key cape cl-generic cl-lib cmake-mode compat
           ...
           diff-hl dired-sidebar diredfl dwim-shell-command easy-kill eat
           editorconfig eglot eldoc elfeed elisp-demos embark-consult
           engine-mode erc eshell-prompt-extras exec-path-from-shell expreg
           external-completion faceup fancy-compilation flymake
           ...
           track-changes tramp use-package verb verilog-mode vertico web-mode
           wgrep which-key window-tool-bar xref yaml-mode yasnippet-snippets
           zig-mode))
