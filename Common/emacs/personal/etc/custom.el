...
(custom-set-variables
 ...
 '(package-selected-packages
      '(adoc-mode anzu apheleia avy bind-key cape cl-generic cl-lib cmake-mode compat
           consult-dir consult-eglot consult-xref-stack corfu crux csv-mode
           deft devdocs-browser diff-hl dired-sidebar diredfl docker
           dockerfile-mode dwim-shell-command easy-kill editorconfig eglot
           eldoc elfeed elisp-demos embark-consult engine-mode erc
           eshell-prompt-extras exec-path-from-shell expreg external-completion
           faceup fancy-compilation flymake gcmh go-mode gptel-quick helpful
           ...
           modern-tab-bar modus-themes monkeytype multiple-cursors nadvice
           no-littering nov ntlm orderless org org-superstar password-store
           pdf-view-restore peg persistent-scratch php-mode project
           project-tab-groups python rainbow-delimiters request rust-mode seq
           shrink-path so-long soap-client spacious-padding surround svg
           tab-bar-echo-area tabspaces track-changes tramp use-package verb
