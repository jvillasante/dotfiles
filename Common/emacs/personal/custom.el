...
(custom-set-variables
 ...
 '(package-selected-packages
      '(adoc-mode anzu apheleia bind-key cape casual-suite cl-generic cl-lib
           ...
           dwim-shell-command editorconfig eglot eldoc elfeed elisp-demos
           embark-consult engine-mode erc eshell-prompt-extras
           exec-path-from-shell expreg external-completion faceup
           fancy-compilation flymake gcmh go-mode gptel helpful hl-todo
           ...
           treesit-auto use-package vc-use-package verb verilog-mode vertico
           vterm vundo web-mode wgrep which-key whole-line-or-region
