...
(custom-set-variables
 ...
 '(package-selected-packages
      '(adoc-mode anzu apheleia avy bind-key cape cl-generic cl-lib cmake-mode compat
           consult-dir consult-xref-stack corfu crux csv-mode deft
           ...
           elisp-demos emamux embark-consult engine-mode erc
           eshell-prompt-extras exec-path-from-shell expreg external-completion
           faceup fancy-compilation flymake forge gcmh go-mode gptel-quick
           helpful hl-todo ibuffer-project idlwave jinx js2-mode json-mode
           jsonrpc let-alist lua-mode magit map marginalia markdown-mode
           ...
           so-long soap-client surround svg track-changes tramp use-package
