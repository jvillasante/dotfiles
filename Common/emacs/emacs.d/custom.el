...
(custom-set-variables
 ...
 '(package-selected-packages
      '(activities adoc-mode anzu apheleia avy bind-key cape casual cl-generic cl-lib
           cmake-mode compat compile-angel consult-dir consult-notes
           consult-xref-stack corfu crux csv-mode devdocs-browser diff-hl
           ...
           erc eshell-prompt-extras exec-path-from-shell expreg
           external-completion faceup fancy-compilation flymake go-mode
           gptel-quick helpful hl-todo ibuffer-project idlwave jinx js2-mode
           json-mode jsonrpc let-alist lua-mode magit map marginalia
           ...
           rainbow-delimiters request rmsbolt rust-mode scratch seq shrink-path
