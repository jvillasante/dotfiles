...
(custom-set-variables
 ...
 '(package-selected-packages
      '(adoc-mode agent-shell anzu bind-key cape cl-generic cl-lib cmake-mode compat
           ...
           flash flymake geiser-guile gnuplot go-mode helpful hl-todo
           ibuffer-project idlwave jinx js2-mode json-mode jsonrpc ledger-mode
           ...
           org org-superstar otpp package-lint-flymake password-store
           pdf-view-restore peg persistent-scratch php-mode project python
           rmsbolt rust-mode seq shell-maker so-long soap-client surround svg
           track-changes tramp-hlo trashed ultra-scroll use-package verb
