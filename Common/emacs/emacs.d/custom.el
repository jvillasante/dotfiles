...
(custom-set-variables
 ...
 '(package-selected-packages
      '(adoc-mode anzu apheleia bind-key cape casual-suite cl-generic cl-lib
           cmake-mode compat consult-dir consult-notes corfu crux csv-mode
           deadgrep devdocs-browser diff-hl dired-sidebar diredfl docker
           dockerfile-mode dwim-shell-command easy-kill eat editorconfig eglot
           eldoc eldoc-diffstat elfeed elisp-demos embark-consult engine-mode
           erc eshell-prompt-extras exec-path-from-shell expreg
           external-completion faceup fancy-compilation flymake gcmh
