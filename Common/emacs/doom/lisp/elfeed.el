...
(after! elfeed
    ...
    (setc elfeed-search-title-min-width 60)
    (setc elfeed-search-title-max-width 100)
...
(after! elfeed-org
    (setc rmh-elfeed-org-files (list (expand-file-name "Apps/elfeed/elfeed.org" +my/dropbox-path))))
