...
def LoadSystemIncludes():
    ...
    process = subprocess.Popen(['/usr/local/opt/llvm/bin/clang', '-v', '-E', '-x', 'c++', '-'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE);
...
flags = [
  ...
  '-stdlib=libc++',
  '-I', '.',
  # '-I', 'src/libs/stduuid/include',
  # '-I', 'src/libs/date/include/date',
